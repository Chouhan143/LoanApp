...
const PersonalLoan: React.FC = () => {
  ...
  const handleGenderSelect = (radioButtons: RadioButtonProps[]) => {
    const selectedButton = radioButtons.find(button => button.selected);
    if (selectedButton) {
      setGenderSelect(selectedButton.value || '');
    }
  };

  const handleMaritalSelect = (radioButtons: RadioButtonProps[]) => {
    const selectedButton = radioButtons.find(button => button.selected);
    if (selectedButton) {
      setMaritalSelect(selectedButton.value || '');
    }
  };
